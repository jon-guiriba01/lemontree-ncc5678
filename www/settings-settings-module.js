...
module.exports = "<ion-header>\n  <ion-toolbar color=\"primary\">\n    <ion-buttons >\n      <ion-back-button></ion-back-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n\t<h6>Settings</h6>\n\t<div class='main-container'>\n\t\t<div>\n\t\t\t<ion-button class='change-password-btn' (click)='openChangePasswordForm($event)' >\n\t\t\t\tCHANGE PASSWORD\n\t\t\t</ion-button>\n\t\t\t<div class='change-password-form closed-list'>\n\t\t\n\t\t\t\t<form [formGroup]=\"changePasswordForm\">\n\t\t\t\t\t<ion-row>\n\t\t\t\t\t\t<ion-col>\n\t\t\n\t\t\t\t\t\t\t<ion-item>\n\t\t\t\t\t\t\t  <ion-label position='floating' class='input-label'>New Password</ion-label>\n\t\t\t\t\t\t\t  <ion-input type='password' formControlName='password' ></ion-input>\n\t\t\t\t\t\t\t</ion-item>\n\n\t\t\t        <div class=\"error-list\" >\n\t\t\t        \t<div *ngFor=\"let validation of validationMessages.password\" >\n\t\t\t\t        \t<h5 class=\"error-msg\" *ngIf=\"changePasswordForm.get('password').hasError(validation.type) && (changePasswordForm.get('password').dirty || changePasswordForm.get('password').touched)\" >\n\t\t\t\t        \t\t{{validation.message}}\n\t\t\t\t        \t</h5>\n\t\t\t        \t</div>\n\t\t\t        </div>\n\n\t\t\t\t\t\t</ion-col>\n\t\t\t\t\t</ion-row>\n\n\t\t\t\t\t<ion-row>\n\n\t\t\t\t\t\t<ion-col>\n\t\t\t\t\t\t\t<ion-item>\n\t\t\t\t\t\t\t  <ion-label position='floating' class='input-label'>Repeat Password</ion-label>\n\t\t\t\t\t\t\t  <ion-input type='password' formControlName='repassword'  ></ion-input>\n\t\t\t\t\t\t\t</ion-item>\n\n\t\t\t        <div class=\"error-list\" >\n\t\t\t        \t<div *ngFor=\"let validation of validationMessages.repassword\" >\n\t\t\t\t        \t<h5 class=\"error-msg\" *ngIf=\"changePasswordForm.get('repassword').hasError(validation.type) && (changePasswordForm.get('repassword').dirty || changePasswordForm.get('repassword').touched)\" >\n\t\t\t\t        \t\t{{validation.message}}\n\t\t\t\t        \t</h5>\n\t\t\t        \t</div>\n\t\t\t        </div>\n\t\t\t\t\t\t</ion-col>\n\n\t\t\t\t\t</ion-row>\n\t\t\t\t\t<ion-row>\n\t\t\t\t\t\t<ion-button class='submit-change-password-btn' (click)='confirmChangePassword($event)' >\n\t\t\t\t\t\tConfirm\n\t\t\t\t\t\t</ion-button>\n\t\t\t\t\t</ion-row>\n\t\t\t\t</form>\n\n\t\t\t</div>\n\t\t</div>\n\t\t<ion-button class='logout-btn' (click)='logout($event)' >\n\t\t\tLogout\n\t\t</ion-button>\n\t</div>\n</ion-content>\n\n\n<ion-toolbar color=\"primary\" class='extra-toolbar'>\n</ion-toolbar>"
...
module.exports = ".signup-card {\n  background: var(--dark-bg);\n  position: relative;\n  padding-top: 40px;\n  margin-top: 30px;\n  padding-bottom: 50px; }\n\n.back-btn {\n  width: 38px;\n  height: 32px;\n  cursor: pointer;\n  margin-top: 8px;\n  position: absolute;\n  z-index: 999;\n  top: 0;\n  left: 0;\n  --color: var(--ion-color-light);\n  color: var(--ion-color-light); }\n\n.team-input {\n  --padding-bottom: 18px; }\n\nion-content {\n  /*--background: var(--red);*/ }\n\n.main-header {\n  color: var(--ion-color-dark-tint);\n  font-weight: bold;\n  text-align: center;\n  font-size: 18px;\n  background: var(--ion-color-light-tint);\n  border-radius: 25px;\n  align-items: center;\n  max-width: 180px;\n  padding: 8px 0; }\n\n.main-container {\n  justify-content: center;\n  align-items: center;\n  height: 90%; }\n\n@media (max-width: 599px) {\n    .main-container {\n      height: 75%; } }\n\nh6 {\n  font-size: 30px;\n  text-align: center;\n  color: var(--yellow);\n  margin-bottom: 20px;\n  font-weight: bold; }\n\nion-button {\n  --background: var(--ion-color-light-tint);\n  --color: var(--ion-color-dark-tint);\n  margin-bottom: 30px;\n  max-width: 280px;\n  font-size: 20px; }\n\n.change-password-form {\n  max-width: 280px;\n  margin: 0 auto;\n  display: block;\n  padding: 8px;\n  background: var(--ion-color-light-tint);\n  margin-bottom: 50px;\n  transition: max-height 0.25s ease-in;\n  overflow: hidden; }\n\n.change-password-btn {\n  margin: 0 auto;\n  display: block; }\n\n.submit-change-password-btn {\n  margin: 0 auto;\n  font-size: 16px;\n  padding: 5px; }\n\n.closed-list {\n  height: 0;\n  max-height: 0;\n  padding: 0; }\n\n.extra-toolbar {\n  height: 15px; }\n\n@media (max-width: 599px) {\n  ion-toolbar {\n    /*height: 35px;*/ } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SettingsPage = /** @class */ (function () {
    function SettingsPage(formBuilder, authService, router, afs, afa) {
    ...
    SettingsPage.prototype.navTo = function (route) {
        this.router.navigateByUrl(route);
    };
    SettingsPage.prototype.openChangePasswordForm = function (evt) {
        if (jquery__WEBPACK_IMPORTED_MODULE_5__('.change-password-form').hasClass('closed-list'))
            jquery__WEBPACK_IMPORTED_MODULE_5__('.change-password-form').removeClass('closed-list');
        else
            jquery__WEBPACK_IMPORTED_MODULE_5__('.change-password-form').addClass('closed-list');
    };
    SettingsPage.prototype.confirmChangePassword = function (evt) {
        var password = this.changePasswordForm.get('password').value;
        firebase__WEBPACK_IMPORTED_MODULE_8__["auth"]().currentUser.updatePassword(password).then(function (res) {
            console.log('update password success', res);
        }).catch(function (err) {
            console.log("err", err);
        });
    };
    SettingsPage.prototype.logout = function (evt) {
        console.log("loguot");
        js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.set('user', null);
